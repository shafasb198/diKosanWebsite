            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Semua sistem berjalan normal! Anda memiliki <span class="text-primary">3 pemberitahuan!</span></h6>
                </div>
                <div class="col-12 col-xl-4">
                 <div class="justify-content-end d-flex">
                  <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                    <button class="btn btn-sm btn-light bg-white dropdown-toggle" type="button" id="dropdownMenuDate2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                     <i class="mdi mdi-calendar"></i> Hari Ini (31 Des 2021)
                    </button>
      ...
      <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="kosan-add-act.php" enctype="multipart/form-data">
                    
                    <div class="form-group">
                      <label for="username">Nama Kos</label>
                      <input type="text" class="form-control" name="namakos" placeholder="Nama Kos">
                    </div>
                    <div class="form-group">
                      <label for="username">Alamat Kos</label>
                      <input type="text" class="form-control" name="alamat" placeholder="Alamat Kos">
                    </div>
                    <div class="form-group">
                    <label for="exampleFormControlSelect2">Tipe Kos</label>
                    <select class="form-control" name="tipe">
                      <option>Pilih Tipe Kos</option>
                      <option>Pria</option>
                    ...
                    <select class="form-control" name="kapasitas">
                      <option>Pilih Kapasitas Kos</option>
                      <option>1</option>
                      <option>2</option>
                      <option>3</option>
                      <option>4</option>
                    ...
                    <select class="form-control" name="jangka">
                      <option>Pilih Jangka Pembayaran</option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="luas" placeholder="Luas Kos">
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Fasilitas</label>
                      <input type="text" class="form-control" placeholder="Fasilitas Kosan" name="fasilitas" rows="4">
                    </div>
                    <div class="form-group">
                      <label for="username">Harga</label>
                      <input type="text" class="form-control" name="harga" placeholder="Harga Kos">
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary mr-2" name="btn-add">Submit</button>
