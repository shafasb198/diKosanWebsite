...
<div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- partial -->
      <?php  
        $s="select*from tb_pengguna where id_pengguna='$_GET[id_pengguna]'";
      ...
      <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="admin-act-edit.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <?php echo "<img src='../pengguna/".$row['foto']."' width='100px' height='100px'>" ?>
                          <input name="f1" type="file" required/>
                          <input type="hidden" name="foto" value="<?php echo $row['foto']?>"/><br><br>
                          </div>
                    </div>
