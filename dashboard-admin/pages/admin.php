...
<div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <?php
          ...
          include "../../koneksi.php";
          $getadmin = "SELECT * FROM tb_pengguna WHERE level='admin'";
          $eks = mysqli_query($conn, $getadmin);
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table style="width: 100%;">
                    <tr>
                        <th style="float:left">
                        <a href="admin-add.php"><button type="button" class="btn btn-outline-warning btn-icon-text">           
                      Tambah
                    </button></a>
                            </th>
                        <th><form method="post" style="float:right;">
                                <input type="text" class="search-box" name="cari" placeholder="Cari Admin...">&ensp;
                        ...
                        <table id="example" class="display expandable-table" style="width:100%">
                          ...
                          <?php
                            if(isset($_POST['btn_cari'])){
                              if($_POST['cari']!=""){
                                $spec = "%".$_POST['cari']."%";
                                $query = "SELECT * FROM tb_pengguna WHERE tb_pengguna.id_pengguna LIKE '%".$_POST['cari']."%'
                                OR tb_pengguna.nama LIKE '%".$_POST['cari']."%' OR tb_pengguna.username LIKE '%".$_POST['cari']."%' order by tb_pengguna.id_pengguna";
                            ...
                            if($hasil>0){
                                while($data = mysqli_fetch_array($eks)){
                                    ...
                                    echo "<td width='20%'> <img src='../pengguna/".$data['foto']."' width='100px' height='100px'></td>";
                                    echo "<td><a href ='admin-edit.php?id_pengguna=".$data['id_pengguna']."' name='edit'><button class='btn btn-inverse-success btn-sm'>Edit</button></a>&nbsp;
                                              <a href ='admin-delete.php?id_pengguna=".$data['id_pengguna']."' name='pending'><button class='btn btn-inverse-danger btn-sm'>Hapus</button></a>
                                    </td>";
                                }
                            }else{
